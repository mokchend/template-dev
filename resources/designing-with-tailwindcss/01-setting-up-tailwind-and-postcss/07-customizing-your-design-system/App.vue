    ...
    <div class="bg-gray-100 flex">
      <div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
        <div class="xl:max-w-lg xl:ml-auto">
          <img class="h-10" src="/designing-with-tailwindcss/img/logo-blue.svg" alt="Workcation">
          <img class="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-72 sm:w-full sm:object-cover sm:object-center lg:hidden" src="/designing-with-tailwindcss/img/beach-work.jpg" alt="Woman workcationing on the beach">
      ...
      popularDestinations: [
        {
          ...
          averagePrice: 120,
          propertyCount: 76,
          imageUrl: '/designing-with-tailwindcss/img/toronto.jpg',
        ...
        },
        {
          ...
          averagePrice: 215,
          propertyCount: 43,
          imageUrl: '/designing-with-tailwindcss/img/malibu.jpg',
        ...
        },
        {
          ...
          averagePrice: 130,
          propertyCount: 115,
          imageUrl: '/designing-with-tailwindcss/img/chicago.jpg',
        ...
        },
        {
          ...
          averagePrice: 135,
          propertyCount: 63,
          imageUrl: '/designing-with-tailwindcss/img/seattle.jpg',
        ...
        },
        {
          ...
          averagePrice: 85,
          propertyCount: 47,
          imageUrl: '/designing-with-tailwindcss/img/colorado.jpg',
        ...
        },
        {
          ...
          averagePrice: 115,
          propertyCount: 86,
          imageUrl: '/designing-with-tailwindcss/img/miami.jpg',
